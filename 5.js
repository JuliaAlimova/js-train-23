...
class BankTransfer {
  ...
  calculateFee = (amount) => amount * 1.02;
}
...
class TransferAdapter {
  ...
  initiateTransfer(amount) {
    ...
    return `Переказ здійснено: $${calculatedAmount}`;
  }
...
// ЗАЧЕМ ЗДЕСЬ КЛАССЫ TransferAdapter И WalletTransfer , ЕСЛИ ОНИ НЕ УЧАСТВУЮТ В КОДЕ?
